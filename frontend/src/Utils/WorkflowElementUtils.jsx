...
const getTitleAndDescription = (type) => {
    switch (type) {
        case "invoce":
            return { title: "Cobrança", description: "Geração QR Code dinamico" };
        case "centerprice":
            return { title: "centerprice de pagamento", description: "centerprice do valor da cobraça percentual ou estático." };
