...
const HomePage = () => {
    ...
    useEffect(() => {
        ...
        }, 500); // Adiciona um pequeno atraso para aplicar a transição
    }, []);
    ...
    useEffect(() => {
        if (elements.length > 0) {
            ...
            allElements.forEach((el, index) => {
                ...
                }, index * 100); // Aplica a transição com um atraso entre os elementos
            });
        }
    }, [elements]);
    ...
    return (
        <div className="App">
            ...
            <Jarvis onChatInteraction={handleChatInteraction} />
        </div>
    );
};
